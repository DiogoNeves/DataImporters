...
__all__ = ['AUDIO_EXTENSION', 'Source', 'normalise_label', 'normalise_all_labels', 'get_footstep_type', 'get_filenames',
           'get_audio_filenames', 'remove_extension', 'remove_prefix', 'get_hash', 'process']
